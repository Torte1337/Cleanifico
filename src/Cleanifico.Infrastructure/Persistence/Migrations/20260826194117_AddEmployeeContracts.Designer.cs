...
namespace Cleanifico.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260826194117_AddEmployeeContracts")]
    partial class AddEmployeeContracts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cleanifico.Domain.EmployeeContracts.EmployeeContract", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .IsFixedLength()
                    ...
                    b.Property<decimal>("MonthlyTargetHours")
                        .HasPrecision(7, 2)
                    ...
                    b.Property<decimal>("VacationDaysPerYear")
                        .HasPrecision(5, 2)
                    ...
                    b.HasIndex("EmployeeId", "IsActive", "StartDate", "EndDate")
            ...
            modelBuilder.Entity("Cleanifico.Domain.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .IsFixedLength()
            ...
            modelBuilder.Entity("Cleanifico.Domain.EmployeeContracts.EmployeeContract", b =>
                {
                    b.HasOne("Cleanifico.Domain.Employees.Employee", null)
                        .WithMany()
